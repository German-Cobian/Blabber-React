    ...
    <div className="container">
      <div className="ms-5">
        <div className="d-flex flex-row justify-content-start my-5 ms-5">
          <h3>{currentUser.username === conversations.title_1 ? conversations.title_2 : conversations.title_1}</h3>
        </div>
        <div key={id}>
          <ul>
        ...
        <form className="d-flex flex-row justify-content-end" onSubmit={onSubmit}>
